...
## rouge
export ROUGE=/home/agi/DYH/fast_abs_rl-master/pyrouge/tools/ROUGE-1.5.5
...
##To decode, run
python3 decode_full_model.py --path=/home/agi/DYH/fast_abs_rl-master/data/ --model_dir=/home/agi/DYH/fast_abs_rl-master/data/full_model/ --beam=5  --test
```
...
```
## run evaluation by:
python3 eval_full_model.py --rouge --decode=/home/agi/DYH/fast_abs_rl-master/data
...
##data dir
export DATA="/home/agi/DYH/fast_abs_rl-master/data/cnn-dailymail-master/finished_files"
`export DATA=[path/to/decompressed/data]`
...
## train separately
python3 train_abstractor.py --path="/home/agi/DYH/fast_abs_rl-master/data/abstractor" --w2v="/home/agi/DYH/fast_abs_rl-master/data/word2vec.128d.226k.bin"
python3 train_extractor_ml.py --path="/home/agi/DYH/fast_abs_rl-master/data/extractor" --w2v="/home/agi/DYH/fast_abs_rl-master/data/word2vec.128d.226k.bin"
```
...
python3 train_full_rl.py --path="/home/agi/DYH/fast_abs_rl-master/data/full_model" --abs_dir="/home/agi/DYH/fast_abs_rl-master/data/abstractor" --ext_dir="/home/agi/DYH/fast_abs_rl-master/data/extractor"
